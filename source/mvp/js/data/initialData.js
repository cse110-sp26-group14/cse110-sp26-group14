/**
 * Default application seed data for first-time load.
 * @module data/initialData
 */
...
export const INITIAL_DATA = {
  ...
  meetings: [
    {
      ...
      goal: 'Sync blockers and sprint progress',
    },
  ],
  tasks: [
  ...
  reports: [
    { id: 1, userId: 1, date: '2026-05-13', status: 'In Progress', mood: 'Good', progress: 'Lead standup', blockers: 'None', timestamp: '2026-05-13T09:00:00' },
    { id: 2, userId: 2, date: '2026-05-13', status: 'In Progress', mood: 'Neutral', progress: 'OAuth work', blockers: 'Staging down', timestamp: '2026-05-13T09:30:00' },
  ],
  aiLogs: [
