...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SE SitRep — Team Status Dashboard" },
      { name: "description", content: "Engineering team status, check-ins, sprint planning and AI agents in one place." },
      { property: "og:title", content: "SE SitRep" },
      { property: "og:description", content: "Engineering team operations center." },
